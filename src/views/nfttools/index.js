...
const hotList = [
    // {id:1, name: "batch Airdrop", desc:" One-to-many batches, convenient and fast, saving time and effort", link: "airdrop"},
    // {id:2, name: "batch Gather", desc:" Many-to-one batch collection", link: "gather"},
]
